...
public class RustiumMod implements ModInitializer {
        public static final String MOD_ID = "rustium";
        ...
        public void onInitialize() {
                ...
                try {
                    pro.nitic.rustium.rustium.RustNativeOffloader.ARENA.allocate(1);
                ...
                CommandRegistrationCallback.EVENT.register((dispatcher, registryAccess, environment) -> {
                    dispatcher.register(literal("rustiumbench").executes(context -> {
                        pro.nitic.rustium.rustium.RustiumTestRunner.runTests(context.getSource());
                        return 1;
                    }));
                });
